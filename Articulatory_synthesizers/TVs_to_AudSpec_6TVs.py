...
'''
This script implements the articulatory synthesizer which uses the entire train set but only 6 TVs as inputs
...
out = "figs/NEW_with_only_1_loss_for_speech_DATE_SI_6TVs_" + str(date.today()) + "_H_" + str(datetime.datetime.now().hour)
out_dir = "./figs/NEW_with_only_1_loss_for_speech_DATE_SI_6TVs_" + str(date.today()) + "_H_" + str(datetime.datetime.now().hour) + "/"
...
parser.add_argument('--train_data', type=str,  default=base_dir+"SI_data/New_train_files/train_audio_XRMB_2sec_new.data",
                    help='path to training data')

parser.add_argument('--dev_data', type=str,  default=base_dir+"SI_data/New_train_files/dev_audio_XRMB_2sec_new.data",
                    help='path to dev data')

parser.add_argument('--test_data', type=str,  default=base_dir+"SI_data/New_train_files/test_audio_XRMB_2sec_new.data",
                    help='path to testing data')

parser.add_argument('--initialization_data', type=str,  default=base_dir+"SI_data/New_train_files/dev_audio_XRMB_ext_2sec_new.data",
...
print("Training")
#
trainTogether_newTechnique(epochs=250, init=True, loader_eval="train", save_better_model=True, name='init')
